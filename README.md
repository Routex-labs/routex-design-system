...
| 경로 | 역할 | 현재 상태 |
|---|---|---|
| `packages/routex_design_system/` | semantic foundation, 공통 컴포넌트, Navigation 제품 패턴 | `0.0.1` bootstrap, 공개 위젯 beta |
| `apps/showcase/` | 실제 Runtime Kit을 검수하는 Flutter Web 카탈로그와 모바일 UX 목업 | 사용 가능 |
